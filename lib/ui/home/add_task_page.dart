...
class _AddTaskPageState extends State<AddTaskPage> {
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            // Last row with 1 item + Create New
                            Padding(
                              padding: const EdgeInsets.only(bottom: 16),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  _buildCategoryItem(9), // Home
                                  _buildCreateNewItem(),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Fixed height container for priority grid
                        SizedBox(
                          height: 200,
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 60), // Empty spaces
  ...
  Widget _buildPriorityItem(int priority, int? tempPriority, StateSetter setStateDialog) {
